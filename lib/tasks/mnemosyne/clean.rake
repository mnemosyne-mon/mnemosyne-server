...
namespace :mnemosyne do
  ...
  task clean: :environment do
    ...
    ActiveRecord::Base.connection.execute <<~SQL
      SELECT _timescaledb_internal.drop_chunks_impl(#{cutoff}, 'traces', NULL);
      SELECT _timescaledb_internal.drop_chunks_impl(#{cutoff}, 'spans', NULL);
      SELECT _timescaledb_internal.drop_chunks_impl(#{cutoff}, 'failures', NULL);
    SQL
